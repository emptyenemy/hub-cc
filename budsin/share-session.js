// budsin/share-session.js
//
// Снимает «живую» сессию аккаунта аккаунта (cookies + localStorage)
// в Playwright storageState-формате и сохраняет в budsin/sessions/<label>.json.
//
// Использование:
//   node budsin/share-session.js <label>
